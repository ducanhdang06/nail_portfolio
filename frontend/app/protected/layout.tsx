            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="flex flex-col space-y-2">
                  <a href="/protected#home" className="text-sm hover:text-blush transition-colors">Home</a>
                  <a href="/protected#about" className="text-sm hover:text-blush transition-colors">About</a>
                  <a href="/protected#services" className="text-sm hover:text-blush transition-colors">Services</a>
                  <a href="/protected#booking" className="text-sm hover:text-blush transition-colors">Book Now</a>
                </div>
              </div>
              <div>
